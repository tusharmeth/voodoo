package com.github.crembluray.voodoo.engine.loaders.assimp;
...
import com.github.crembluray.voodoo.engine.graph.Material;
...
import com.github.crembluray.voodoo.engine.graph.anim.Animation;
...
public class AnimMeshesLoader extends StaticMeshesLoader {
    ...
    public static AnimGameObject loadAnimGameItem(String resourcePath, String texturesDir)
            throws Exception {
    ...
    public static AnimGameObject loadAnimGameItem(String resourcePath, String texturesDir, int flags)
            throws Exception {
        ...
        AnimGameObject item = new AnimGameObject(meshes, animations);
