...
import com.github.crembluray.voodoo.engine.graph.shadow.ShadowCascade;
import com.github.crembluray.voodoo.engine.graph.shadow.ShadowRenderer;
    ...
    private void renderNonInstancedMeshes(Scene scene) {
        ...
        for (Mesh mesh : mapMeshes.keySet()) {
            ...
            mesh.renderList(mapMeshes.get(mesh), (GameObject gameObject) -> {
                sceneShaderProgram.setUniform("selectedNonInstanced", gameObject.isSelected() ? 1.0f : 0.0f);
