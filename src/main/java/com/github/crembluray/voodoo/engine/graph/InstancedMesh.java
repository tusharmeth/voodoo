...
public class InstancedMesh extends Mesh {
    ...
    private void renderChunkInstanced(List<GameObject> gameObjects, boolean billBoard, Transformation transformation, Matrix4f viewMatrix) {
        ...
        for (GameObject gameObject : gameObjects) {
            ...
            this.instanceDataBuffer.put(buffPos, billBoard ? gameObject.getScale() : gameObject.isSelected() ? 1 : 0);
        ...
        glDrawElementsInstanced(
                GL_TRIANGLES, getVertexCount(), GL_UNSIGNED_INT, 0, gameObjects.size());
