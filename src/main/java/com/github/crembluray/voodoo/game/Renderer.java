...
public class Renderer {
    ...
    public void render(Window window, Camera camera, GameObject[] gameObjects, Vector3f ambientLight,
        ...
        for (GameObject gameObject : gameObjects) {
            ...
            // Render all gameObject children
            ...
            if(children != null) {
                for(GameObject child : children) {
                    ...
                    if(childMesh != null) {
                        ...
                        Matrix4f modelViewMatrix = transformation.getModelViewMatrix(child, viewMatrix);
                        shaderProgram.setUniform("modelViewMatrix", modelViewMatrix);
                        // Render the mesh for this component
                        shaderProgram.setUniform("material", childMesh.getMaterial());
                        childMesh.render();
                    }
                }
            }
