...
import voodoo.engine.graph.ShaderProgram;
import voodoo.engine.graph.Transformation;
import voodoo.engine.light.DirectionalLight;
import voodoo.engine.light.PointLight;
import voodoo.engine.light.SceneLight;
import voodoo.engine.light.SpotLight;
...
public class Renderer {
    ...
    private void setupSkyBoxShader() throws Exception {
        ...
        skyBoxShaderProgram.createVertexShader(Utils.loadResource("/shaders/vertex_SB.vs"));
        skyBoxShaderProgram.createFragmentShader(Utils.loadResource("/shaders/fragment_SB.fs"));
